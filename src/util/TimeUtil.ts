...
export class TimeUtil {
    ...
    static formatImageSrc(instant: number): string {
        const date = new Date(instant);
        return `images/l${String(date.getFullYear()).padStart(4, '0')}${String(date.getMonth() + 1).padStart(2, '0')}${String(date.getDate()).padStart(2, '0')}.png`;
    }
